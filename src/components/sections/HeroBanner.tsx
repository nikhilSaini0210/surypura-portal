...
const AnimatedWord: FC<{ words: string[] }> = ({ words }) => {
  ...
  return (
    ...
    >
      <div className="absolute inset-0 z-0">
        ...
        <div
          className="absolute bottom-1/4 right-1/4 w-80 h-80 bg-yellow-500/8 rounded-full blur-3xl animate-pulse"
      ...
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none z-0">
        <div
          className="w-[500px] h-[500px] border border-green-500/5 rounded-full animate-spin"
          style={{ animationDuration: "20s" }}
        />
        <div
          className="absolute w-[700px] h-[700px] border border-green-500/5 rounded-full animate-spin"
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-0">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="text-center lg:text-left">
            ...
            >
              A model village in Maharashtra where smart governance, digital
              identity, modern education, and farmer empowerment create a
              blueprint for rural India's future.
            </motion.p>
