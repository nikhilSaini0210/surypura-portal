...
const SocialMediaPosts: FC = () => {
  return (
    <section
      id="social"
      className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-gray-950 to-gray-900 relative overflow-hidden"
    >
            ...
            >
              ...
              >
                <div className="flex items-center justify-between mb-4">
                  ...
                  <div
                    className={`text-2xl ${post.platform === "instagram" ? "text-pink-400" : "text-sky-400"}`}
                  >
                    {post.platform === "instagram" ? (
                      <FaInstagram />
                    ) : (
                ...
                {post.contentHindi && (
                  <p className="text-green-400/60 text-xs font-hindi mb-3 italic">
                    {post.contentHindi}
                  </p>
                )}
