...
export default function AboutLeader() {
  return (
    <section id="about" className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-gray-950 to-green-950/20 relative overflow-hidden">
          ...
          <ScrollReveal direction="left">
            ...
            >
              ...
              <div className="relative backdrop-blur-md bg-white/5 border border-white/10 rounded-2xl p-8 text-center">
                ...
                <h3 className="text-white text-xl font-bold">Rameshwar Patel</h3>
                <p className="text-green-400 font-hindi text-sm mb-1">रमेश्वर पटेल</p>
                <p className="text-gray-400 text-sm mb-4">Sarpanch, Surypura Gram Panchayat</p>

                <div className="bg-green-500/10 border border-green-500/20 rounded-xl p-4 text-left mb-4">
                  <p className="text-gray-300 text-sm italic leading-relaxed">
                    "Every citizen of Surypura deserves dignity, opportunity, and a future.
                     My mission is to ensure no family is left behind in India's development story."
                  </p>
                </div>
                ...
                <div className="grid grid-cols-2 gap-2">
                  {ACHIEVEMENTS.map((a, i) => (
                    ...
                    >
                      ...
                      <p className="text-gray-400 text-[10px] leading-tight">{a.text}</p>
                    </motion.div>
                  ))}
                </div>
              </div>
          ...
          <ScrollReveal direction="right" delay={0.2}>
            <div className="space-y-6">
              ...
              <p className="text-gray-400 leading-relaxed">
                Born in Surypura itself, Rameshwar Patel grew up watching his father struggle with poor roads, no electricity, and no access to government schemes. At 32, he contested the Gram Panchayat election on a single promise:{' '}
                <em className="text-green-400">transform Surypura in 5 years.</em>
              </p>
              <p className="text-gray-400 leading-relaxed">
                He delivered — and more. Today, Surypura is a national model with 100% digital identity coverage, solar-powered streets, upgraded schools, and a farmer welfare program that has tripled agricultural income.
              </p>
