      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div>
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <p className="text-green-400 text-sm font-hindi">
                  ग्राम पंचायत
                </p>
              </div>
            </div>
            <p className="text-gray-400 text-sm leading-relaxed mb-4">
              A model village leading India's rural transformation through smart
              governance, sustainable development, and digital empowerment.
            </p>
        ...
        <div className="border-t border-white/10 pt-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-gray-500 text-sm text-center sm:text-left">
            © 2026 Surypura Gram Panchayat. Made with ❤️ for rural India.
          </p>
